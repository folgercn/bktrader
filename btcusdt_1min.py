...
# CONFIG
OUT_DIR = "btc_perp_1m_dataset"
os.makedirs(OUT_DIR, exist_ok=True)
OUTPUT_FILE = os.path.join(OUT_DIR, "BTCUSDT_perp_1m_master.parquet")
SYMBOL = "BTCUSDT"
        ...
        if content:
            try:
                ...
                for inner in z.namelist():
                    with z.open(inner) as f:
                        fd = pd.read_csv(f)
                        # ✅ 修复：列名是 calc_time 不是 fundingTime
