...
* [bktrader-ctl runtime](bktrader-ctl_runtime.md)	 - 统一运行态观测
...
* [bktrader-ctl supervisor](bktrader-ctl_supervisor.md)	 - Runtime Supervisor 观测
* [bktrader-ctl update](bktrader-ctl_update.md)	 - 检查并更新 bktrader-ctl [MUTATING]
* [bktrader-ctl version](bktrader-ctl_version.md)	 - 显示 bktrader-ctl 构建版本 [IDEMPOTENT]
