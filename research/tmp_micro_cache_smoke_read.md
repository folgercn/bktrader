...
- Summary JSON: `research/tmp_micro_cache_smoke_read_summary.json`
- `ETHUSDT signal_struct_skipweak` ledger: `research/tmp_micro_cache_smoke_read_ETHUSDT_signal_struct_skipweak_ledger.csv`
