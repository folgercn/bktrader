...
| `ETHUSDT` | 73 | 0.6264% | 2.1059% | 1.5117% | 1.167483 | 65.75% | -0.7498% | 1717.00s | `{'TrailingSL': 39, 'InitialSL': 25, 'BreakevenSL': 9}` | `{'candidate_events': 75, 'entries': 73, 'busy_skipped': 1, 'same_signal_bar_skipped': 0, 'dwell_skipped': 0, 'min_stop_skipped': 1, 'missing_entry_second': 0}` |
...
| Month | Trades | Weighted Realistic | Win |
|---|---:|---:|---:|
| `2026-01` | 24 | -0.453357% | 58.3333% |
| `2026-02` | 28 | 0.555770% | 64.2857% |
| `2026-03` | 21 | 0.528925% | 76.1905% |
