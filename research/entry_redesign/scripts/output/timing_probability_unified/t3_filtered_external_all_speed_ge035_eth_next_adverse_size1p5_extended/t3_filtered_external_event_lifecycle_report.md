...
- T3 size scale: `1.5`
- T3 reentry size schedule: `[0.30000000000000004, 0.15000000000000002]`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `all_speed_abs_ge_0p35` | 8.530000% | 0.775455% | -0.620000% | 3 | 163 | 18.336190% | 74 | 71 | `{"speed_abs_min": 0.35}` | both sides with absolute 300s speed >= 0.35 ATR; direct-entry diagnostic |
