...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `low_eff_rf_rank_median_external_raw_touch_next_second_open_t3_60m` | -0.590000% | -0.053636% | -0.700000% | 6 | 88 | 53 | 35 | 3.349230% | -0.502810% | 28 | 27 | Inject low_eff_rf_rank_median_000 active events as explicit breakout locks; native original_t2 remains disabled; event source=raw_touch; external entry mode=next_second_open. |
