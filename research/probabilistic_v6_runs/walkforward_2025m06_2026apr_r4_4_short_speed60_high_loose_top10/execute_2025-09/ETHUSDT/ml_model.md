...
|---:|---:|---:|---:|---:|---:|---:|
| 2 | 100.0000% | 0.810127 | 1.620255 | 0.956742 | 0.513025 | 0.000000 |

## Model Leaderboard

| Rank | Model | Prob Min | EV Min | SL Max | Events | Success | Net Edge ATR | Sum Net Edge ATR | Score |
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | `logistic` | 0.0 | -999.0 | 1.0 | 2 | 100.0000% | 0.810127 | 1.620255 | -999.000000 |

## Metrics

| Model | Brier | Log Loss | AUC | SL Brier | SL Log Loss | SL AUC |
|---|---:|---:|---:|---:|---:|---:|
| `logistic` | 0.00353300 | 0.04512972 | 0.00000000 | 0.00353300 | 0.04512972 | 0.00000000 |
| `random_forest` | 0.20903067 | 0.60906955 | 0.00000000 | 0.20903067 | 0.60906955 | 0.00000000 |
| `extra_trees` | 0.21274803 | 0.61609696 | 0.00000000 | 0.21274803 | 0.61609696 | 0.00000000 |
| `gradient_boosting` | 0.02743547 | 0.13421738 | 0.00000000 | 0.02743547 | 0.13421738 | 0.00000000 |
| `svm_rbf` | 0.24950201 | 0.69213869 | 0.00000000 | 0.36965114 | 0.94924581 | 0.00000000 |
