...
|---:|---:|---:|---:|---:|---:|---:|
| 2 | 0.0000% | -0.242867 | -0.485733 | 0.752833 | 0.123850 | 0.000000 |

## Model Leaderboard

| Rank | Model | Prob Min | EV Min | SL Max | Events | Success | Net Edge ATR | Sum Net Edge ATR | Score |
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | `logistic` | 0.0 | -999.0 | 1.0 | 2 | 0.0000% | -0.242867 | -0.485733 | -999.000000 |

## Metrics

| Model | Brier | Log Loss | AUC | SL Brier | SL Log Loss | SL AUC |
|---|---:|---:|---:|---:|---:|---:|
| `logistic` | 0.61448403 | 2.15755512 | 0.00000000 | 0.56114914 | 1.67849236 | 0.00000000 |
| `random_forest` | 0.24873548 | 0.69061813 | 0.00000000 | 0.24997258 | 0.69309235 | 0.00000000 |
| `extra_trees` | 0.23988413 | 0.67290319 | 0.00000000 | 0.27118081 | 0.73555473 | 0.00000000 |
| `gradient_boosting` | 0.38436876 | 1.06319110 | 0.00000000 | 0.35606699 | 0.96726449 | 0.00000000 |
| `svm_rbf` | 0.33847190 | 0.87484064 | 0.00000000 | 0.35208989 | 0.90376068 | 0.00000000 |
