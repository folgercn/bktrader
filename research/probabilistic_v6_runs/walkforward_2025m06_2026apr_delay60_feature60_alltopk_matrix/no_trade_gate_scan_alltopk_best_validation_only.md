...
- 组合约束：active_rows>=1，active_months>=1，trades>=1，worst_month>=-999.00%。
...
|---:|---|---:|---:|---:|---:|---:|---:|---|---|
| 1 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=0.0, ret/DD<=5.0, ret<=5.0%, markov>=0.3 |
| 2 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=0.0, ret/DD<=5.0, ret<=5.0%, markov>=0.4 |
| 3 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=999.0%, markov>=-999.0 |
| 4 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=999.0%, markov>=0.3 |
| 5 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=5.0%, markov>=0.4 |
| 6 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=7.0%, markov>=0.3 |
| 7 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=7.0%, markov>=-999.0 |
| 8 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=999.0%, markov>=0.4 |
| 9 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=5.0%, markov>=-999.0 |
| 10 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=7.0%, markov>=0.3 |
| 11 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=5.0%, markov>=-999.0 |
| 12 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=5.0%, markov>=0.3 |
| 13 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=5.0%, markov>=0.4 |
| 14 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=7.0%, markov>=-999.0 |
| 15 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=999.0%, markov>=0.4 |
| 16 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=7.0%, markov>=0.4 |
| 17 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=1.0, ret/DD<=5.0, ret<=5.0%, markov>=0.3 |
| 18 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=999.0%, markov>=-999.0 |
| 19 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=999.0%, markov>=0.3 |
| 20 | `best_validation_per_symbol_month` | 5 | 4 | 48 | 8.3563% | 12.5259 | -0.7250% | `False` | edge>=0.1, ret>=1.0%, SL<=0.25, DD<=1.0%, ret/DD>=2.0, ret/DD<=5.0, ret<=7.0%, markov>=0.4 |

## Best Non-Empty Selection

- policy=`best_validation_per_symbol_month`，active_rows=5，trades=48，total_realistic=8.3563%，worst_month=-0.7250%。
...
- policy=`best_validation_per_symbol_month`，active_rows=5，active_months=4，trades=48，total_realistic=8.3563%，silo_PF=12.5259，target_hit=`False`。
