...
|---:|---:|---:|---:|---:|---:|---:|
| 4 | 100.0000% | 0.266440 | 1.065760 | 0.409746 | -0.119926 | 0.000000 |

## Model Leaderboard

| Rank | Model | Prob Min | EV Min | SL Max | Events | Success | Net Edge ATR | Sum Net Edge ATR | Score |
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | `logistic` | 0.0 | -999.0 | 1.0 | 4 | 100.0000% | 0.266440 | 1.065760 | -999.000000 |

## Metrics

| Model | Brier | Log Loss | AUC | SL Brier | SL Log Loss | SL AUC |
|---|---:|---:|---:|---:|---:|---:|
| `logistic` | 0.43142337 | 1.21444793 | 0.00000000 | 0.25830135 | 0.79270989 | 0.00000000 |
| `random_forest` | 0.26641796 | 0.72530608 | 0.00000000 | 0.26521454 | 0.72029903 | 0.00000000 |
| `extra_trees` | 0.26395541 | 0.72133323 | 0.00000000 | 0.25877397 | 0.70977157 | 0.00000000 |
| `gradient_boosting` | 0.31724169 | 0.84082834 | 0.00000000 | 0.29695758 | 0.80736744 | 0.00000000 |
| `svm_rbf` | 0.19165134 | 0.57586046 | 0.00000000 | 0.16785769 | 0.52107535 | 0.00000000 |
