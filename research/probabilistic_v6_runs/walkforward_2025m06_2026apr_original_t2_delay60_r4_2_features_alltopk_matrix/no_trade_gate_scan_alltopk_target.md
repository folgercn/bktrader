...
|---:|---|---:|---:|---:|---:|---:|---:|---|---|---|
| 1 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.0%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=5.0%, markov>=0.0 |
| 2 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.0%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=7.0%, markov>=0.3 |
| 3 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.0%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=7.0%, markov>=0.0 |
| 4 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.0%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=999999.0%, markov>=0.0 |
| 5 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.3%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=5.0%, markov>=0.0 |
| 6 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.0%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=999999.0%, markov>=0.3 |
| 7 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.3%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=7.0%, markov>=0.0 |
| 8 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=7.0%, markov>=0.0 |
| 9 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=5.0%, markov>=0.0 |
| 10 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.3%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=999999.0%, markov>=0.3 |
| 11 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.3%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=7.0%, markov>=0.3 |
| 12 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.3%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=10.0%, markov>=0.3 |
| 13 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=10.0%, markov>=0.0 |
| 14 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.3%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=5.0%, markov>=0.3 |
| 15 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=999999.0%, markov>=0.0 |
| 16 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.3%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=10.0%, markov>=0.0 |
| 17 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.3%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=999999.0%, markov>=0.0 |
| 18 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=10.0%, markov>=0.3 |
| 19 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=7.0%, markov>=0.3 |
| 20 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=999999.0%, markov>=0.3 |
| 21 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=5.0%, markov>=0.3 |
| 22 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.0%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=5.0%, markov>=0.3 |
| 23 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.0%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=10.0%, markov>=0.0 |
| 24 | `all_sleeves` | 18 | 4 | 140 | 28.7110% | 70.7038 | 0.4160% | `False` | `False` | edge>=0.08, ret>=0.0%, SL<=0.4, DD<=2.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=10.0%, markov>=0.3 |
| 25 | `all_sleeves` | 20 | 4 | 173 | 28.2199% | 29.9613 | -0.0751% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=100.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=7.0%, markov>=0.0 |
| 26 | `all_sleeves` | 20 | 4 | 173 | 28.2199% | 29.9613 | -0.0751% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=100.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=7.0%, markov>=0.3 |
| 27 | `all_sleeves` | 20 | 4 | 173 | 28.2199% | 29.9613 | -0.0751% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=100.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=999999.0%, markov>=0.0 |
| 28 | `all_sleeves` | 20 | 4 | 173 | 28.2199% | 29.9613 | -0.0751% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=100.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=10.0%, markov>=0.0 |
| 29 | `all_sleeves` | 20 | 4 | 173 | 28.2199% | 29.9613 | -0.0751% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=100.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=999999.0%, markov>=0.3 |
| 30 | `all_sleeves` | 20 | 4 | 173 | 28.2199% | 29.9613 | -0.0751% | `False` | `False` | edge>=0.08, ret>=0.5%, SL<=0.4, DD<=100.0%, ret/DD>=1.0, ret/DD<=7.0, ret<=10.0%, markov>=0.3 |

## Best Non-Empty Selection

- policy=`all_sleeves`，active_rows=18，trades=140，total_realistic=28.7110%，worst_month=0.4160%，unique_symbol_month=`False`。
...
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-01` | `BTCUSDT` | 10 | 7 | -0.1373% | 2.2006 | 0.4788 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-01` | `BTCUSDT` | 15 | 7 | -0.1373% | 3.0505 | 0.5193 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-01` | `BTCUSDT` | 20 | 7 | -0.1373% | 3.0505 | 0.5193 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-01` | `ETHUSDT` | 5 | 5 | 0.7800% | 1.0466 | 0.5521 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-01` | `ETHUSDT` | 10 | 5 | 0.7800% | 2.1811 | 0.5794 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-01` | `ETHUSDT` | 20 | 5 | 0.7800% | 2.0236 | 0.6154 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-02` | `BTCUSDT` | 10 | 10 | 0.0690% | 1.4619 | 0.4717 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-02` | `BTCUSDT` | 15 | 15 | 1.9593% | 1.6143 | 0.4076 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-02` | `BTCUSDT` | 20 | 16 | 2.3050% | 1.9047 | 0.3912 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-02` | `ETHUSDT` | 5 | 5 | 2.0056% | 5.2935 | 0.6934 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-02` | `ETHUSDT` | 10 | 7 | 2.5318% | 5.7820 | 0.5470 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-02` | `ETHUSDT` | 15 | 7 | 2.5318% | 5.7820 | 0.5470 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-02` | `ETHUSDT` | 20 | 7 | 2.5318% | 5.7820 | 0.5470 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-03` | `ETHUSDT` | 5 | 5 | 3.0942% | 5.3430 | 0.5827 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-03` | `ETHUSDT` | 10 | 9 | 3.1128% | 3.7095 | 0.6030 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-03` | `ETHUSDT` | 15 | 9 | 3.1128% | 3.7095 | 0.6030 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-03` | `ETHUSDT` | 20 | 9 | 3.1128% | 3.7095 | 0.6030 |

## Best Qualified Selection

- policy=`all_sleeves`，active_rows=20，active_months=6，trades=139，total_realistic=23.0362%，silo_PF=7.0915，unique_symbol_month=`False`，target_hit=`False`。
...
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-03` | `ETHUSDT` | 15 | 9 | 3.1128% | 3.7095 | 0.6030 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-03` | `ETHUSDT` | 20 | 9 | 3.1128% | 3.7095 | 0.6030 |
| `walkforward_2025m06_2026apr_original_t2_delay60_r4_2_features_alltopk_matrix` | `2026-04` | `ETHUSDT` | 5 | 5 | -1.3074% | 11.6036 | 0.4307 |
