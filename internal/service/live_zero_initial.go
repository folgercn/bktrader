...
func prepareLivePlanStepForSignalEvaluation(
	...
	pendingWindow := map[string]any{
		...
		"longBreakoutBoundaryReady":   boolValue(gate["longBreakoutBoundaryReady"]),
		"shortBreakoutBoundaryReady":  boolValue(gate["shortBreakoutBoundaryReady"]),
		"longBreakoutMarginReady":     boolValue(gate["longBreakoutMarginReady"]),
		"shortBreakoutMarginReady":    boolValue(gate["shortBreakoutMarginReady"]),
		"longBreakoutDistance":        parseFloatValue(gate["longBreakoutDistance"]),
		"shortBreakoutDistance":       parseFloatValue(gate["shortBreakoutDistance"]),
		"longBreakoutRequiredMargin":  parseFloatValue(gate["longBreakoutRequiredMargin"]),
		"shortBreakoutRequiredMargin": parseFloatValue(gate["shortBreakoutRequiredMargin"]),
		"breakoutMinATRMargin":        parseFloatValue(gate["breakoutMinATRMargin"]),
