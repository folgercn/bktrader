...
func NewStore() *Store {
	...
	pretouchStrategy := domain.Strategy{
		...
		Status:      "ACTIVE",
		Description: "ETHUSDT 1h live pretouch timing strategy with Go-native timing classifier, RF probability sizing, and testnet shadow risk-on telemetry.",
		CreatedAt:   now,
	}
	...
	pretouchVersion := domain.StrategyVersion{
		...
		Parameters: map[string]any{
			...
			"pretouchShadowMode":                           "testnet_shadow_collect",
			"pretouchShadowCandidateID":                    "lead_q020_q040_overlay_q020_q040_t3_rf_cost_20260520",
			"pretouchShadowLeadScale":                      1.5,
			"pretouchShadowLeadQuantityBandSizing":         true,
			"pretouchShadowLeadQuantityMinQuantity":        0.20,
			"pretouchShadowLeadQuantityMaxQuantity":        0.40,
			...
			"pretouchShadowStrict15CalendarPct":            28.970948,
			"pretouchShadowSevere15CalendarPct":            21.231073,
